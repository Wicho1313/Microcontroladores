...
; 0000 0027 PORTA=(1<<PORTA7) | (1<<PORTA6) | (1<<PORTA5) | (1<<PORTA4) | (1<<PORTA3) | (1<<PORTA2) | (1<<PORTA1) | (1<<PORTA0);
	OUT  0x1B,R30
; 0000 0028 
...
; 0000 0084 while (1){
_0x4:
; 0000 0085     variable=PIND&0x0f; //Enmascaramos los 4 bits menos significativos del puerto A ya que los demás no interesan.
	IN   R30,0x10
	ANDI R30,LOW(0xF)
	MOV  R5,R30
; 0000 0086     variable2=PINC&0x0f;
	IN   R30,0x13
	ANDI R30,LOW(0xF)
	MOV  R4,R30
; 0000 0087 
...
; 0000 0089         PORTB=tabla7segmentos[variable];
	...
	RJMP _0xE
; 0000 008A     }
; 0000 008B     else if (variable>=10){ //Si lo que leemos es mayor o igual de 10 que dibuje en el display una E de ERROR
_0x7:
	LDI  R30,LOW(10)
	CP   R5,R30
	BRLO _0x9
; 0000 008C         PORTB=0x79;
	LDI  R30,LOW(121)
_0xE:
	OUT  0x18,R30
; 0000 008D     }
; 0000 008E     if (variable2<10){
_0x9:
	LDI  R30,LOW(10)
	CP   R4,R30
	BRSH _0xA
; 0000 008F         PORTA=~(tabla7segmentos[variable2]);
	...
	RJMP _0xF
; 0000 0090     }
; 0000 0091     else if (variable2>=10){ //Si lo que leemos es mayor o igual de 10 que dibuje en el display una E de ERROR
_0xA:
	LDI  R30,LOW(10)
	CP   R4,R30
	BRLO _0xC
