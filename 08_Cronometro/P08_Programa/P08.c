...
while (1)
      ...
      //BOTON RESET    
      if ((botonp_reset==1)&&(botona_reset==0)){ //hubo cambio de flanco de 1 a 0
        var=0;
        var2=0; 
        var3=0;
        estado=0;
      ...
      if ((botonp_reset==0)&&(botona_reset==1)) //hubo cambio de flanco de 0 a 1
        delay_ms(40); //Se coloca retardo de 40mS para eliminar rebotes
      //BOTON STOP  
      if ((botonp_stop==1)&&(botona_stop==0)){ //hubo cambio de flanco de 1 a 0
        estado=0;
      delay_ms(40); //Se coloca retardo de 40mS para eliminar rebotes
      }
      if ((botonp_stop==0)&&(botona_stop==1)) //hubo cambio de flanco de 0 a 1
        delay_ms(40); //Se coloca retardo de 40mS para eliminar rebotes
      //BOTON START  
      if ((botonp_start==1)&&(botona_start==0)){ //hubo cambio de flanco de 1 a 0
        estado=1;
      delay_ms(40); //Se coloca retardo de 40mS para eliminar rebotes
      }
      if ((botonp_start==0)&&(botona_start==1)) //hubo cambio de flanco de 0 a 1
        delay_ms(40); //Se coloca retardo de 40mS para eliminar rebotes
      ...
      botonp_reset = botona_reset;
      botonp_stop  = botona_stop; 
