...
; 0000 0086       PORTB++;      //incrementa el puerto en una unidad
	IN   R30,0x18
	SUBI R30,-LOW(1)
	OUT  0x18,R30
; 0000 0087       PORTD--;      //decrementa el puerto en una unidad
	IN   R30,0x12
	SUBI R30,LOW(1)
	OUT  0x12,R30
; 0000 0088       delay_ms(750);//retardo que se genera para visualizar
	LDI  R26,LOW(750)
	LDI  R27,HIGH(750)
	RCALL _delay_ms
; 0000 0089       }
