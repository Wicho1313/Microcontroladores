...
_0x11:
	BLD  R2,1
; 0000 008C     if ((botonp==1)&&(botona==0)){ //hubo cambio de flanco de 1 a 0
	SBRS R2,0
	RJMP _0xA
	LDI  R26,0
	SBRC R2,1
...
_0xA:
	RJMP _0x9
_0xB:
; 0000 008D         var++; //Se incrementa la variable
	INC  R5
; 0000 008E         if (var==10)
	LDI  R30,LOW(10)
	CP   R30,R5
...
; 0000 008F             var=0;
	CLR  R5
; 0000 0090         delay_ms(40); //Se coloca retardo de 40mS para eliminar rebotes
_0xC:
	LDI  R26,LOW(40)
	LDI  R27,0
	RCALL _delay_ms
; 0000 0091     }
; 0000 0092     if ((botonp==0)&&(botona==1)) //hubo cambio de flanco de 0 a 1
_0x9:
	LDI  R26,0
	SBRC R2,0
	LDI  R26,1
