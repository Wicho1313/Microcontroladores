...
_0xA:
	RJMP _0x9
_0xB:
; 0000 0090         var2++; //Se incrementa la variable
	INC  R4
; 0000 0091       if (var2==10){
	LDI  R30,LOW(10)
	CP   R30,R4
	BRNE _0xC
; 0000 0092         var2=0;
...
; 0000 009B         delay_ms(40); //Se coloca retardo de 40mS para eliminar rebotes
	...
	RCALL _delay_ms
; 0000 009C 
; 0000 009D       PORTA=tabla7segmentos[var2];
_0xE:
	MOV  R30,R4
	RCALL SUBOPT_0x0
	OUT  0x1B,R30
; 0000 009E       PORTB=tabla7segmentos[var];
	MOV  R30,R5
	RCALL SUBOPT_0x0
	OUT  0x18,R30
; 0000 009F       botonp=botona;
	BST  R2,1
	BLD  R2,0
; 0000 00A0 
; 0000 00A1       }
